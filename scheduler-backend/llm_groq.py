...
- Strict Formatting (CRITICAL): When you extract a 'datetime' field, you MUST ALWAYS convert any natural language the user typed into the EXACT format: Month DD, YYYY at HH:MM AM/PM. Examples: "12 april at 11 am" → "April 12, 2026 at 11:00 AM". "tomorrow 3pm" → "April 12, 2026 at 3:00 PM". NEVER copy the user's raw text into the datetime field. ALWAYS output normalized, fully formatted datetime strings. NEVER ask the user to rephrase the date.
